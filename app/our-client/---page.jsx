...
export const clients = [
  { imgURL: "./images/clients/tata.png" },
  { imgURL: "./images/clients/trafigura.png" },
  { imgURL: "./images/clients/mckinsey.png" },
  { imgURL: "./images/clients/mitsubishiCorporation-logo.webp" },
  { imgURL: "./images/clients/EY-logo.webp" },
  { imgURL: "./images/clients/lonza.png" },
  { imgURL: "./images/clients/kpmg.png" },
  { imgURL: "./images/clients/sbi.png" },
  { imgURL: "./images/clients/kpk.png" },
  { imgURL: "./images/clients/neohealth.png" },
  { imgURL: "./images/clients/bcg.png" },
  { imgURL: "./images/clients/duracell.png" },
  { imgURL: "./images/clients/lgb.png" },
  { imgURL: "./images/clients/yes_bank.png" },
  { imgURL: "./images/clients/netease.png" },
  { imgURL: "./images/clients/afriqom.png" },
  { imgURL: "./images/clients/hsa.png" },
  { imgURL: "./images/clients/taoglas.png" },
  { imgURL: "./images/clients/blickle.png" },
  { imgURL: "./images/clients/frost.png" },
  { imgURL: "./images/clients/clearity.png" },
  { imgURL: "./images/clients/mips.png" },
  { imgURL: "./images/clients/tunwal.png" },
  { imgURL: "./images/clients/archoma.png" },
  { imgURL: "./images/clients/lr.png" },
  { imgURL: "./images/clients/mactech.png" },
  { imgURL: "./images/clients/elite.png" },
  { imgURL: "./images/clients/Biomech.png" },
  { imgURL: "./images/clients/orientbell_logo.png" },
  { imgURL: "./images/clients/gmm.png" },
  { imgURL: "./images/clients/fashionista.png" },
  { imgURL: "./images/clients/milkio.png" },
  { imgURL: "./images/clients/rizir.png" },
  { imgURL: "./images/clients/teachmint.png" },
  { imgURL: "./images/clients/vijay.png" },
  { imgURL: "./images/clients/fudan_university.png" },
  { imgURL: "./images/clients/akros.png" },
  { imgURL: "./images/clients/coeasia.png" },
  { imgURL: "./images/clients/cerbios.png" },
  { imgURL: "./images/clients/glemco.png" },
  { imgURL: "./images/clients/mtek.png" },
  { imgURL: "./images/clients/starrgate.png" },
  { imgURL: "./images/clients/cpkelco.png" },
  { imgURL: "./images/clients/buyofuel.png" },
  { imgURL: "./images/clients/comexcell.png" },
  { imgURL: "./images/clients/aum_group.png" },
  { imgURL: "./images/clients/timberline.png" },
  { imgURL: "./images/clients/mizuho.png" },
  { imgURL: "./images/clients/ushiyakam.png" },
  { imgURL: "./images/clients/anuraj.png" },
  { imgURL: "./images/clients/somany_logo.png" },
  ...
  { imgURL: "./images/clients/inventum.png" },
  { imgURL: "./images/clients/hyosung.png" },
  { imgURL: "./images/clients/siliconi.png" },
  { imgURL: "./images/clients/afepasa.png" },
];
        ...
        <div className="container px-3 md:px-0 mx-auto py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mt-6 gap-4">
            {clients.map((data, index) => (
              ...
              >
                <img src={data.imgURL} className="w-[150px]" alt="" />
              </div>
            ))}
          </div>
        </div>
