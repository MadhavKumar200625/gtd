            ...
            <div className="order-1 lg:order-2 mb-4 md:mb-0">
              <div className="relative mx-auto border-gray-300 bg-gray-border-gray-300 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px]">
                <div className="rounded-md overflow-hidden h-[156px] md:h-[278px] bg-white">
                  <img src="/images/API-1.webp" className="h-[156px] md:h-[278px] w-full rounded-lg" alt="Custom api development" title="Custom api development" /> 
                  {/* <iframe
                    allowFullScreen
            ...
            <div className="">
              ...
              <div className="myshadow p-3 rounded-xl mb-5">
                <div className="p-3 bg-white rounded-lg">
                  ...
                  <p className="text-base text-gray-600">
                  Our trade API company can create an expert market intelligence platform that helps them achieve their international business goals. In trade API, you get full{" "}
                  {" "}
                    <a
          ...
          <div className="md:flex justify-between items-center">
            ...
            <div>
              <a
                ...
                className="rounded-xl px-5 py-2 mybtn font-semibold linerotate inline-flex md:flex items-center group shadow-lg shadow-gray-600 hover:shadow-md ease-in transition-shadow"
              >
