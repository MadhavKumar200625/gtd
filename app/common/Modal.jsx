...
const Modal = ({ openModal, setOpenModal, plan }) => {
    ...
    const timeSlots = Array.from({ length: 48 }, (_, i) => {
        ...
        const format = (h, m) => `${String(h).padStart(2, '0')}:${m}`;
        return `${format(hour, minute)} - ${format(nextHour, nextMinute)}`;
    });

    const filteredSlots = timeSlots.filter(slot => {
        const hour = parseInt(slot.split(':')[0]);
        return amSelected ? hour < 12 : hour >= 12;
    });
        ...
        <>
            <div
                className={`${openModal ? "flex" : "hidden"
                    } md:overflow-x-hidden overflow-y-scroll fixed top-0 left-0 md:top-2/4 md:left-2/4 md:-translate-y-2/4 md:-translate-x-2/4 z-[100] justify-center items-center w-full md:inset-0 h-full md:h-[calc(100%-1rem)] max-h-full bg-white md:bg-transparent pb-5`}
            >
                <div className="relative p-8 rounded-xl w-full max-w-3xl max-h-full bg-white md:border">
                    <h1 className="text-3xl font-bold text-center mb-2">
                        Schedule an Appointment
                    </h1>
                    {/* {plan && (
                        <p className="text-center text-lg font-semibold text-green-600 mb-2">
                            Plan selected: {plan}
                        </p>
                    )} */}
                    <p className="mb-3 text-base text-center font-normal text-gray-700    ">
                        Book an Appointment with our experts for online demo.
                    </p>
                    <button type="button"
                        className="text-gray-400 bg-transparent absolute top-5 right-5 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                    ...
                    <div className="my-8">
                        <div className="flex justify-between mb-2">
                            <span
                                className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-emerald-600 bg-emerald-200"
                                id="step1">
                                Personal Info
                            </span>
                            <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-emerald-600 bg-emerald-200 opacity-50"
                                id="step2">
                                Booking
                            </span>
                            <span
                                className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-emerald-600 bg-emerald-200 opacity-50"
                                id="step3">
                                Finish
                            </span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div
                            id="step-1"
                            className={`step ${showStep(1)} grid md:grid-cols-2 gap-4`}>
                            <div>
                            ...
                            <div>
                                ...
                                {errors.ddlcountry && <p className="text-red-500 text-sm mt-1">{errors.ddlcountry}</p>}
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                //inputMode="numeric"
                                />
                                {errors.txtphone && <p className="text-red-500 text-sm mt-1">{errors.txtphone}</p>}
                            </div>
                        ...
                        <div id="step-2" className={`step ${showStep(2)}`}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 focus:outline-0"
                                        id="Timezone"
                                    ...
                                    >
                                        ...
                                        <option data-time-zone-id="57" data-gmt-adjustment="GMT+05:30" data-use-daylight="0" value="(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi" >(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi</option>
                            ...
                            <div className="flex gap-4 mt-5">
                                <button
                                    type="button"
                                    onClick={() => setAmSelected(true)}
                                    className={`w-16 py-2 rounded-md border font-medium ${amSelected ? 'bg-green-500 text-white' : 'bg-white text-gray-800'
                                        }`}
                                >
                                    AM
                                </button>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mt-4 max-h-[400px] overflow-y-auto">
                                {filteredSlots.map(slot => (
                                    <label
                                        key={slot}
                                        className={`relative flex items-center justify-center text-center text-sm bg-white px-2 py-3 rounded-lg shadow cursor-pointer border transition duration-200 hover:border-green-500 ${formData.AppointmentTime === slot ? 'border-green-500 bg-green-100' : 'border-gray-200'
                                            }`}
                                    >
                        ...
                        <div id="step-3" className={`step ${showStep(3)}`}>
                            <div className="grid grid-cols-3 items-center gap-5">
                                ...
                                <div className="col-span-2">
                                    ...
                                    <p className='text-base font-normal'>"Online link will be shared before the session".
