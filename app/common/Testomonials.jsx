  ...
  return (
    <>
      ...
      <section className="testimonials">
        <div className="container px-3 md:px-0 mx-auto md:py-10">
          <div className="grid md:grid-cols-2 mt-10 gap-10 items-center">
            <div>
              <h3 className="text-4xl font-bold text-black">
                Our Client’s Testimonials
              </h3>
              <h6 className="text-xl mt-4 text-gray-600">
                We are known to deliver quality services to our clients. See
                ...
                <div className="slide_inner">
                  <div className="rounded-lg shadow-md p-4 mb-4 bg-white">
                    ...
                    <div className="flex items-center">
                      <h6 className="text-base text-black font-bold me-2">
                      Avin John
                      </h6>
                      <svg
