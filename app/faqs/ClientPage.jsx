...
const BenefitsFaqs = () => {
  ...
  return (
    <>
      <section>
        <div className="container px-3 md:px-0 mx-auto md:py-20 py-10 ">
          <div className="text-center mb-5">
            <h4 className="text-primary text-lg text-gray-400 font-medium">
              Frequently Asked Questions for
            </h4>
          ...
          <div className="p-4 mb-3 bg-slate-50 shadow-md rounded-xl overflow-hidden text-base text-gray-600">
            ...
            >
              <p className="overflow-hidden text-base text-gray-600">
              Yes, you can obtain the data sample, HS Code List in Excel and PDF format.
              </p>
            </div>
          </div>
          {/* --------------Question Start---------------------- */}
          ...
          <div className="p-4 mb-3 bg-slate-50 shadow-md rounded-xl overflow-hidden text-base text-gray-600">
            ...
            >
              ...
              >
                How can I obtain port data in USA?
              </h5>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
