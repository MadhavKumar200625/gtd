    ...
    <>
      <section className="flex items-center overflow-hidden relative bg-gradient-to-br from-white via-emerald-100 to-blue-100 bg-gradient-45 bg-opacity-50">
        {/*<div className='absolute -top-2/4 w-full h-screen z-0 opacity-10'>
                    <img src="/images/global trade database.webp" className='w-full' alt="" />
                </div> */}
        <div className="py-8 mx-auto container px-3 lg:pt-16 lg:pb-10 z-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <img src="/images/Global-trade-data.webp" className="h-[156px] md:h-[278px] w-full rounded-lg" alt="Global trade database || 200+ countries" title="Global trade database || 200+ countries" /> 
            <div>
              <img
      ...
      <section className="container px-3 md:px-0 mx-auto py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            <span className="text-4xl md:text-5xl text-black font-bold">200+</span>
            <h4 className="text-base md:text-lg font-semibold text-emerald-400">
              Countries
            </h4>
          </div>
          <div className="text-center">
            <span className="text-4xl md:text-5xl text-black font-bold">50 M+</span>
            <h4 className="text-base md:text-lg font-semibold text-emerald-400">
              Importer Companies
            </h4>
          </div>
          ...
          <div className="text-center">
            <span className="text-4xl md:text-5xl text-black font-bold">500 M+</span>
            <h4 className="text-base md:text-lg font-semibold text-emerald-400">
              Shipment Records
            </h4>
          </div>
        ...
        <div className="container mx-auto">
          <div className="mt-10 myshadow rounded-xl p-5 bg-[#f6f9fc]">
            <div className="md:grid grid-cols-3 gap-8">
              ...
              <div>
                <div className="flex items-center gap-1 bg-slate-200 rounded-full py-1 px-1 mb-3 mt-5 md:mt-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
