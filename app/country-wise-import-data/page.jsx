...
const Page = () => {
  ...
  const [data, setData] = useState({
    Armenia: {
      heading: 'Armenia Import Data',
      description: `Find the Latest Armenia Import Customs Shipment Trade Data. Armenia's import data shows that, overall, Armenia's imports declined this year. Armenia's export figures have experienced significant growth over recent years.`,
      topProducts: [
        { name: 'Mineral Fuels', value: '$2.26B' },
        { name: 'Electrical Machinery', value: '$862M' },
        { name: 'Nuclear Reactors', value: '$848M' },
        { name: 'Vehicles', value: '$817M' },
        { name: 'Natural or Cultured', value: '$692M' },
        { name: 'Plastics and Articles', value: '$236M' },
        { name: 'Pharmaceutical Products', value: '$216M' },
        { name: 'Iron and Steel', value: '$207M' },
        { name: 'Optical Medical Instruments', value: '$186M' },
        { name: 'Articles of Iron', value: '$175M' },
      ],

      totalImportValue: '$4.164B (78.57% of total exports)',
      topPartners: [
  ...
  return (
    ...
    <>
      ...
      <Breadcrump
        pageName="Country Wise Import Data"
        heading={data[country]?.heading || 'Import Data'}
        peragraph=""
...
<div className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-gray-700">{`${country}`} IMPORT DATA</span>
                <div className="h-0.5 w-6 bg-green-600"></div>
              </div>
              <h1 className="text-2xl md:text-3xl font-bold text-[#2d2d6d] mb-6">
                Get Latest {`${country}`} Import Customs Shipment Trade Data
              </h1>

              <div className="max-w-4xl">
                <p className="mb-4 text-gray-700">
                  <span className="font-semibold">{`${country}`} import data</span> depicts rapid growth in the country's
                  overall imports this year. Past year import data of {`${country}`} suggests the country's total imports to be
                  valued around $5.38 in FY 2022. Nuclear reactors, vehicles and Electrical machinery were responsible
                  for the maximum product wise {`${country}`} imports. Germany and Italy accounted for the most volume for
                  {`${country}`} imports by country. {`${country}`} import companies can gain quality leads through global market
                  intelligence reports.
                </p>
                <p className="mb-6 text-gray-700 italic">
                  Get historical or latest {`${country}`} import data 2023, product wise {`${country}`} import statistics, {`${country}`} 
                    importers list, global buyers & suppliers list and port volume reports.
                </p>
      ...
      <section className="py-20 bg-blue-950">
        <div className="container mx-auto">
          <h2 className="mx-auto mb-2 text-center text-balance text-2xl md:text-4xl font-bold leading-snug my-2 text-white">
            {`${country}`}  Import Data 2023-24 Overview
          </h2>
      ...
      {/* ---------Overview end-------------- */}
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <div className="h-0.5 w-6 bg-green-600"></div>
              <span className="text-sm font-medium text-gray-700">{`${country}`} IMPORT TRADE DATA</span>
              <div className="h-0.5 w-6 bg-green-600"></div>
            </div>
            ...
            <div className="max-w-4xl text-gray-700">
              <p className="mb-4">
                Our {`${country}`} import data contains all essential information that could help you spot verified buyers from
                the global market. You can find top imports of {`${country}`} by hs code, price, quantity, country, {`${country}`}
              ...
              <p className="mb-4">
                ...
                or customized plans at a reasonable price. You could find a detailed sample import data of {`${country}`} by{" "}
        ...
        <div className="container mx-auto px-4 md:px-0">
          <div className="md:grid grid-cols-2 items-center">
            ...
            <div>
              <h3 className="text-primary text-lg text-gray-600 font-medium">
                Global Trade Data Intelligence System
              </h3>
          ...
          <div className="mt-20">
            <h2 className="mx-auto mb-2 text-center text-balance text-4xl font-bold leading-snug my-2">
              {`${country}`} Import Data 2023-24
            </h2>
            <p className="text-base text-gray-600 text-center">
              Global Trade Data Solution Intelligence System is the best platform which
              gives you real time access to {`${country}`} imports data from
              2012 to the latest. This portal will help you find {`${country}`}’s main
              imports product pricing, quantity, top
              importing markets to {`${country}`}, ports volume, {`${country}`} import
              companies turnover, competitor shipments along with their
              total import value & % share. Below, we have shared the insights
              into {`${country}`} imports during FY 2023-24.
            </p>
            <div
              className={`flex mt-5 relative w-80 mx-auto py-2 items-center justify-center text-center rounded-full bg-white overflow-hidden shadow-inner shadow-gray-500/80 before:absolute before:h-full before:w-40  before:rounded-full before:top-0 before:z-10 before:transition-all before:left-0 before:ease-in 
      ...
      <div className="mt-20 ">
            ...
            <h2 className="mx-auto mb-2 text-center text-balance text-2xl md:text-4xl font-bold leading-snug my-2">
              Important Links Related to {`${country}`} Import data
            </h2>
